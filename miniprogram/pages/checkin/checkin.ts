...
import { TAB_INDEX, STATUS_OPTIONS, MOOD_OPTIONS } from '../../config/constants';
...
Page({
  ...
  onShow() {
    wx.nextTick(() => {
      ...
      if (tabBar && tabBar.data.selected !== TAB_INDEX.CHECKIN) tabBar.setData({ selected: TAB_INDEX.CHECKIN });
    });
    this._loadToday();
  },
